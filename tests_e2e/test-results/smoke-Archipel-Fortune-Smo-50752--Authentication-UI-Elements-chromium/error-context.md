...
- Name: smoke.spec.ts >> Archipel Fortune Smoke Tests >> Authentication UI Elements
- Location: tests\smoke.spec.ts:54:7
...
Locator: getByLabel('AUTH_SUBMIT_BTN')
Expected: visible
Timeout: 20000ms
...
Call log:
  ...
  - waiting for getByLabel('AUTH_SUBMIT_BTN')
